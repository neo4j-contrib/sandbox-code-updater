...
public interface GitOperations {
    ...
    void clone(Path cloneLocation, String repositoryUri, String token) throws IOException;
    ...
    void push(Path cloneLocation, String token, String remote, String branch) throws IOException;
