...
They are based on https://github.com/neo4j-graph-examples/template/tree/master/code[the code samples versioned here] and tailored to every sandbox,
based on the metadata they each define in their README files (via a specific Asciidoc code listing).
